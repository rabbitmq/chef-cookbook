...
# tcp_listen_options
default['rabbitmq']['tcp_packet'] = 'raw'
default['rabbitmq']['tcp_reuseaddr'] = true
default['rabbitmq']['tcp_backlog'] = 128
default['rabbitmq']['tcp_nodelay'] = true
default['rabbitmq']['tcp_exit'] = false
default['rabbitmq']['tcp_keepalive'] = false
